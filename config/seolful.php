...
return [
     ...
     * SEOLFUL_NEXTJS_TOKEN is generated by seolful:install --nextjs-path and written
     * to both this .env and your Next.js app's .env.local automatically.
     */
    'nextjs' => [
        'token' => env('SEOLFUL_NEXTJS_TOKEN', ''),
    ],
